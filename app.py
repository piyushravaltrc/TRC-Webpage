...
from scripts.NIS_web import process_nis
from scripts.Retention_web import process_retention
from scripts.tds_deduction_calculation import process_tds_deduction_calculation
from scripts.gst_itc_web import process_gst_itc
